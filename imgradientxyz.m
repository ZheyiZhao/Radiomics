...
%   [Gx, Gy, Gz] = IMGRADIENTXYZ(I) takes a grayscale or binary 3-D image I
...
%   subscripts. Gx, Gy and Gz are the same size as the input image I.
%
%   [Gx, Gy, Gz] = IMGRADIENTXYZ(I, METHOD) calculates the directional
%   gradients of the image I using the specified METHOD. Supported METHODs
%   are:
%
...
%   Class Support 
%   ------------- 
%   The input image I can be numeric or logical three-dimensional matrix, and
%   it must be nonsparse. Gx, Gy and Gz are of class double, unless the
%   input image I is of class single, in which case Gx, Gy and Gz will be of
%   class single.
%
%   Notes
%   -----
